# Pull Request Workflows - Platform-Neutral Concepts
...
- **GitHub-specific operations**: See [GitHub PR Operations](./rules-github-pr.md), [GitHub Agent Workflows](./rules-github-agent-*.md)
...
- **GitHub Operations**: `$HOME/.smith/rules-github-pr.md` - GitHub PR operations
