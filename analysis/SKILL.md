...
**MECE relationship**:
- `@analysis/SKILL.md` - Constructive thinking (how to reason)
- `@clarity/SKILL.md` - Defensive thinking (what to avoid)
- `@validation/SKILL.md` - Proving/testing (verifying correctness)
