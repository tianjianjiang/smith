...
Maps conceptual path variables to IDE-specific syntax. For variable definitions and usage, see [Naming Standards](@rules-naming.md#path-reference-standards).

## Conceptual Variables

**Defined in**: [Naming Standards](@rules-naming.md#path-reference-standards)
...
- **Path Standards**: @rules-naming.md
