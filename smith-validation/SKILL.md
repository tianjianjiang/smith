...
See `references/TECHNIQUES.md` for:
- Explanation techniques (Rubber Duck, Feynman)
- Systematic isolation (Delta Debugging, TRAFFIC)
- Version control debugging (Git Bisect)
- Coverage-based localization (SBFL)
