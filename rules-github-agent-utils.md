# GitHub Agent Workflow Utilities

<metadata>

- **Scope**: General agent workflow coordination, hooks, CI checks, troubleshooting
- **Load if**: Pre-commit hooks, CI coordination, amend operations, workflow troubleshooting
- **Prerequisites**: [PR Concepts](./rules-pr-concepts.md), [Git Standards](./rules-git.md)
...
- **This document**: Shared utilities across agent workflows, pre-commit hooks, CI checks, amend safety, troubleshooting
- **Specific workflows**: See [Review](./rules-github-agent-review.md), [Rebase](./rules-github-agent-rebase.md), [Create](./rules-github-agent-create.md), [Merge](./rules-github-agent-merge.md)
...
**Solution**: See "Recovery if You Made This Mistake" in [PR Concepts](./rules-pr-concepts.md#recovery-if-you-made-this-mistake)
...
- **Git Standards**: `$HOME/.smith/rules-git.md` - Local git operations, amend operations
