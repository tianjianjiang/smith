...
**MECE relationship**:
- @reasoning.md - Constructive thinking (how to reason)
- @clarity.md - Defensive thinking (what to avoid)
- @validation.md - Proving/testing (verifying correctness)
...
- @steering.md - Anti-sycophancy, questioning techniques
- @reasoning.md - Pre-mortem analysis, constraint thinking
